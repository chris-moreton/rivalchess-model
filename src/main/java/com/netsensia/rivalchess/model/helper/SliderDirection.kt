...
enum class SliderDirection(val xIncrement: Int, val yIncrement: Int) {
    ...
    companion object {
        private val queenDirections: List<SliderDirection> = ArrayList(Arrays.asList(
                NE, NW, SE, SW,
                N, W, S, E
        ))
        private val rookDirections: List<SliderDirection> = ArrayList(Arrays.asList(
                N, W, S, E
        ))
        private val bishopDirections: List<SliderDirection> = ArrayList(Arrays.asList(
                NE, NW, SE, SW
        ))
